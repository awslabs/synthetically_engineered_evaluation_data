...
- [Plan](plan.md): turn free text, example data, a formal schema, real documents, or an ERD into one canonical `InferredSchema` that drives either output modality.
